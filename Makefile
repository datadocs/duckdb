...
ifeq (${BUILD_DATADOCS}, 1)
	BUILD_EXTENSIONS:=${BUILD_EXTENSIONS};datadocs
	CMAKE_VARS:=${CMAKE_VARS} -DBUILD_DATADOCS_EXTENSION=1
	ifeq (${DATADOCS_DEBUG_FILE_IO}, 1)
		CMAKE_VARS:=${CMAKE_VARS} -DDATADOCS_DEBUG_FILE_IO=1
	endif
endif
ifeq (${BUILD_INET}, 1)
